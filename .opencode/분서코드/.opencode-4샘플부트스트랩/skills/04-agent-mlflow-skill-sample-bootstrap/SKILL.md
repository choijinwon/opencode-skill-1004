...
다음 단계: 3. 환경 검증 또는 5. 원격 MLflow 등록 실행
```
...
```text
샘플 목록:
& ".opencode/scripts/common/invoke-aistudio-python.ps1" ".opencode/scripts/04-sample-bootstrap/bootstrap_sample_project.py" --list -AutoInstallIfMissing

복사 전 확인:
& ".opencode/scripts/common/invoke-aistudio-python.ps1" ".opencode/scripts/04-sample-bootstrap/bootstrap_sample_project.py" --project . --sample pytorch -AutoInstallIfMissing

실제 복사:
& ".opencode/scripts/common/invoke-aistudio-python.ps1" ".opencode/scripts/04-sample-bootstrap/bootstrap_sample_project.py" --project . --sample pytorch --execute -AutoInstallIfMissing

기존 모델 골격 보충:
& ".opencode/scripts/common/invoke-aistudio-python.ps1" ".opencode/scripts/04-sample-bootstrap/bootstrap_sample_project.py" --project . --sample pytorch --scaffold-existing --execute -AutoInstallIfMissing
```
